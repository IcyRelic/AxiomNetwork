 ...
 * @author IcyRelic
 */
public class FakeQuitCommand extends AxiomSubCommand {

    public FakeQuitCommand(Command parent) {
        super(parent, "quit");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        AxiomAPI.Instance.getServer().broadcastMessage(Format.replace(Language.MESSAGE_QUIT.getMessage(), new String[]{"%player%"}, new String[] {name}));
    }
}
